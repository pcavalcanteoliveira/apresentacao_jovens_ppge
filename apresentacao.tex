...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'ggplot2' was built under R version 3.4.4}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'dplyr' was built under R version 3.4.4}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in check\_breaks\_labels(breaks, labels): object 'percent' not found}}\end{kframe}
\end{knitrout}
\end{figure}
\end{frame}
